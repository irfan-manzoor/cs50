...
NONTERMINALS = """
S -> NP VP
NP -> N | Det N | Det Adj N | Det N PP | Det Adj N PP | N PP | Adj N | NP Conj NP | NP Adv
PP -> P NP
...
def preprocess(sentence):
    ...
    # Filter out words that do not contain alphabetic characters
...
def contains_np(tree):
    """
    Helper function to check if a subtree contains any other
    noun phrases as subtrees.
    """
    for subtree in tree.subtrees():
